...
<body class="hold-transition Deep Pinksidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
<div class="wrapper">

  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <a href="#" class="logo me-auto"><img src="guest/img/logo.png" alt="" class="img-fluid" height="60" width="60"></a>
  </div>

  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-Deep Pink">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Data Aturan</span>
